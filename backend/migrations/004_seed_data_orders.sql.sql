-- =================================================================
-- 004_seed_data_orders.sql
-- Mengisi data pesanan awal (seed) SESUAI skema tabel terbaru.
-- Jalankan file ini paling terakhir.
-- =================================================================
...
INSERT INTO orders (
    ...
    status, 
    shipping_option, payment_option, payment_details, 
    address_text, created_at
) 
VALUES (
    1, 2, 617000.00, 
    'Alice Wonderland', 'alice@store.com', '081234567890',
    'Processing', 
    'JNE', 'Credit Card', '**** **** **** 1234',
...
VALUES (
    2, 3, 598000.00, 
    'Bob Builder', 'bob@store.com', '087654321098',
    'Delivering', 
    'Sicepat', 'Bank Transfer', 'BCA',
